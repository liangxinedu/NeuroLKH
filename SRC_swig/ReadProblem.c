...
static void Read_NODE_COORD_SECTION(double* invec);
...
void ReadProblem(double* invec)
{
    ...
    Read_NODE_COORD_SECTION(invec);

    while (0 && (Line = ReadLine(ProblemFile))) {
